        ...
        <div class="doctor-widget">
            <div class="doc-info-left">
                <div class="doctor-img">
                    <img src="{{ asset('img/avatar/' . $doctor->avatar) }}" class="img-fluid" alt="User Image">
                </div>
                <div class="doc-info-cont">
                    <h4 class="doc-name">Dr. {{ $doctor->first_name . ' ' . $doctor->last_name }}</h4>
                    <p class="doc-speciality">BDS, MDS - Oral & Maxillofacial Surgery</p>
                    <p class="doc-department"><img src="{{ asset('img/specialities/specialities-05.png') }}" class="img-fluid" alt="Speciality">{{ ucfirst($doctor->userable->speciality) }}</p>
                    <div class="rating">
            ...
            <div class="doc-info-right">
                <div class="clini-infos">
                    <ul>
                        ...
                        <li><i class="far fa-money-bill-alt"></i> ${{ $doctor->userable->price }} per hour </li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-9">
                        ...
                        <div class="widget about-widget">
                            ...
                            <p>{!! nl2br(e($doctor->userable->biography)) !!}</p>
                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                <a href="#/" class="name">{{ $doctorService->getEducation('institute') }}</a>
                                                <div>{{ $doctorService->getEducation('degree') }}</div>
                                                <span class="time">{{ $doctorService->getEducation('completion_year') }}</span>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        @if ($doctor->userable->services != null)
                            <div class="service-list">
                                <h4>Services</h4>
                                <ul class="clearfix">
                                    @foreach ($doctorService->getDoctorServices($doctor->userable->services) as $service)
                                        <li>{{ $service }}</li>
                                    @endforeach
                                </ul>
                            </div>
                        ...
                        @if ($doctor->userable->specialization != null)
                            <div class="service-list">
                                <h4>Specializations</h4>
                                <ul class="clearfix">
                                    @foreach ($doctorService->getDoctorServices($doctor->userable->specialization) as $specialization)
